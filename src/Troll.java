...
public abstract class Troll extends AbstractAction implements Move{
    protected int resourceLimit;
    protected int resourceCount;

    public static final String TROLL_KEY = "Troll";
    public static final int TROLL_ACTION_PERIOD = 0;
    public static final int TROLL_ANIMATION_PERIOD = 1;
    public static final int TROLL_LIMIT = 100;
    public static final int TROLL_NUM_PROPERTIES = 3;
    ...
    public Troll(String id, Point position, List<PImage> images, int resourceLimit, int resourceCount, double actionPeriod, double animationPeriod) {
